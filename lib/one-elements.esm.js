...
let OneCircle = class OneCircle extends s {
    static get styles() {
        return r$2 `
      :host {
        display: flex;
...
], OneCircle.prototype, "radius", void 0);
OneCircle = __decorate([
    n$1('one-circle')
], OneCircle);

let OneSquare = class OneSquare extends s {
    static get styles() {
        return r$2 `
      :host {
        display: flex;
...
__decorate([
    e({ type: Number }),
    __metadata("design:type", Number)
], OneSquare.prototype, "width", void 0);
__decorate([
    e({ type: Number }),
    __metadata("design:type", Number)
], OneSquare.prototype, "height", void 0);
...
let OneButton = class OneButton extends OneBase {
    constructor() {
        super();
        this.icon = false;
        this.disabled = false;
...
], OneButton.prototype, "icon", void 0);
__decorate([
    e({ type: Boolean, reflect: true }),
    __metadata("design:type", Object)
], OneButton.prototype, "disabled", void 0);
__decorate([
    e({ type: String, reflect: true }),
    __metadata("design:type", Object)
], OneButton.prototype, "variant", void 0);
__decorate([
    e({ type: String, reflect: true }),
    __metadata("design:type", Object)
], OneButton.prototype, "color", void 0);
__decorate([
    e({ type: String, reflect: true }),
    __metadata("design:type", Object)
], OneButton.prototype, "size", void 0);
__decorate([
    e({ type: Number }),
    __metadata("design:type", Object)
], OneButton.prototype, "elevation", void 0);
__decorate([
    i('button'),
    __metadata("design:type", HTMLButtonElement)
], OneButton.prototype, "button", void 0);
OneButton = __decorate([
    n$1('one-button'),
    __metadata("design:paramtypes", [])
], OneButton);

let OneCard = class OneCard extends OneBase {
    constructor() {
        super();
    }
    static get styles() {
...
let OneCheckbox = class OneCheckbox extends s {
    constructor() {
        super(...arguments);
        this.checked = false;
        this.disabled = false;
...
__decorate([
    e({ type: Boolean, reflect: true }),
    __metadata("design:type", Object)
], OneCheckbox.prototype, "checked", void 0);
__decorate([
    e({ type: Boolean, reflect: true }),
    __metadata("design:type", Object)
], OneCheckbox.prototype, "disabled", void 0);
__decorate([
    i('input'),
    __metadata("design:type", HTMLInputElement)
], OneCheckbox.prototype, "input", void 0);
OneCheckbox = __decorate([
    n$1('one-checkbox')
], OneCheckbox);

let OneInput = class OneInput extends OneBase {
    constructor() {
        super(...arguments);
        this.checked = false;
        this.type = 'text';
...
__decorate([
    e({ type: Boolean }),
    __metadata("design:type", Object)
], OneInput.prototype, "checked", void 0);
__decorate([
    e({ type: Boolean }),
    __metadata("design:type", Object)
], OneInput.prototype, "type", void 0);
__decorate([
    e({ type: Number }),
    __metadata("design:type", Number)
], OneInput.prototype, "size", void 0);
OneInput = __decorate([
    n$1('one-input')
], OneInput);

let OneRadio = class OneRadio extends OneBase {
    constructor() {
        super(...arguments);
        this.checked = false;
    }
...
__decorate([
    e({ type: Boolean }),
    __metadata("design:type", Object)
], OneRadio.prototype, "checked", void 0);
__decorate([
    e({ type: String }),
    __metadata("design:type", String)
], OneRadio.prototype, "name", void 0);
__decorate([
    i('input'),
    __metadata("design:type", HTMLInputElement)
], OneRadio.prototype, "input", void 0);
OneRadio = __decorate([
    n$1('one-radio')
], OneRadio);

let OneRadioGroup = class OneRadioGroup extends s {
    constructor() {
        super(...arguments);
        this.radioNodes = [];
...
__decorate([
    e({ type: String, reflect: true }),
    __metadata("design:type", String)
], OneRadioGroup.prototype, "selected", void 0);
OneRadioGroup = __decorate([
    n$1('one-radio-group')
], OneRadioGroup);

let OneProgress = class OneProgress extends OneBase {
    constructor() {
        super(...arguments);
        this.value = 0;
        this.min = 0;
...
__decorate([
    e({ type: Number }),
    __metadata("design:type", Object)
], OneProgress.prototype, "value", void 0);
__decorate([
    e({ type: Number }),
    __metadata("design:type", Object)
], OneProgress.prototype, "min", void 0);
__decorate([
    e({ type: Number }),
    __metadata("design:type", Object)
], OneProgress.prototype, "max", void 0);
__decorate([
    e({ type: Boolean }),
    __metadata("design:type", Object)
], OneProgress.prototype, "percentage", void 0);
OneProgress = __decorate([
    n$1('one-progress')
], OneProgress);

let OneToggle = class OneToggle extends OneBase {
    constructor() {
        super(...arguments);
        this.checked = false;
        this.disabled = false;
...
__decorate([
    e({ type: Boolean }),
    __metadata("design:type", Object)
], OneToggle.prototype, "checked", void 0);
__decorate([
    e({ type: Boolean, reflect: true }),
    __metadata("design:type", Object)
], OneToggle.prototype, "disabled", void 0);
__decorate([
    i('input'),
    __metadata("design:type", HTMLInputElement)
], OneToggle.prototype, "input", void 0);
OneToggle = __decorate([
    n$1('one-toggle')
], OneToggle);

let OneSlider = class OneSlider extends OneBase {
    constructor() {
        super(...arguments);
        this.min = 0;
        this.max = 100;
...
__decorate([
    e({ type: Number }),
    __metadata("design:type", Object)
], OneSlider.prototype, "min", void 0);
__decorate([
    e({ type: Number }),
    __metadata("design:type", Object)
], OneSlider.prototype, "max", void 0);
__decorate([
    e({ type: Number }),
    __metadata("design:type", Object)
], OneSlider.prototype, "step", void 0);
__decorate([
    e({ type: Boolean, reflect: true }),
    __metadata("design:type", Object)
], OneSlider.prototype, "disabled", void 0);
__decorate([
    i('input'),
    __metadata("design:type", HTMLInputElement)
], OneSlider.prototype, "input", void 0);
OneSlider = __decorate([
    n$1('one-slider')
], OneSlider);

let OneSpinner = class OneSpinner extends OneBase {
    constructor() {
        super(...arguments);
        this.spinning = false;
        this.duration = 1500;
...
__decorate([
    e({ type: Boolean }),
    __metadata("design:type", Object)
], OneSpinner.prototype, "spinning", void 0);
__decorate([
    e({ type: Number }),
    __metadata("design:type", Object)
], OneSpinner.prototype, "duration", void 0);
OneSpinner = __decorate([
    n$1('one-spinner')
], OneSpinner);

let OneItem = class OneItem extends OneBase {
    constructor() {
        super(...arguments);
        this.value = '';
        this.name = '';
...
__decorate([
    e(),
    __metadata("design:type", Object)
], OneItem.prototype, "value", void 0);
__decorate([
    e(),
    __metadata("design:type", Object)
], OneItem.prototype, "name", void 0);
__decorate([
    e({ type: Boolean }),
    __metadata("design:type", Object)
], OneItem.prototype, "selected", void 0);
OneItem = __decorate([
    n$1('one-item')
], OneItem);

let OneListbox = class OneListbox extends OneBase {
    constructor() {
        super(...arguments);
        this.itemNodes = [];
...
__decorate([
    e({ type: Object }),
    __metadata("design:type", Object)
], OneListbox.prototype, "value", void 0);
__decorate([
    e({ type: String }),
    __metadata("design:type", String)
], OneListbox.prototype, "selected", void 0);
OneListbox = __decorate([
    n$1('one-listbox')
], OneListbox);

let OneCombo = class OneCombo extends s {
    constructor() {
        super(...arguments);
        this.disabled = false;
...
__decorate([
    e({ type: Object }),
    __metadata("design:type", Object)
], OneCombo.prototype, "value", void 0);
__decorate([
    e({ type: String, reflect: true }),
    __metadata("design:type", String)
], OneCombo.prototype, "selected", void 0);
__decorate([
    e({ type: Boolean, reflect: true }),
    __metadata("design:type", Object)
], OneCombo.prototype, "disabled", void 0);
__decorate([
    i('svg'),
    __metadata("design:type", SVGSVGElement)
], OneCombo.prototype, "svg", void 0);
__decorate([
    i('#card'),
    __metadata("design:type", HTMLDivElement)
], OneCombo.prototype, "card", void 0);
OneCombo = __decorate([
    n$1('one-combo')
], OneCombo);

let OneTextarea = class OneTextarea extends OneBase {
    constructor() {
        super(...arguments);
        this.placeholder = '';
    }
...
__decorate([
    e({ type: String }),
    __metadata("design:type", Object)
], OneTextarea.prototype, "placeholder", void 0);
__decorate([
    i('textarea'),
    __metadata("design:type", HTMLTextAreaElement)
], OneTextarea.prototype, "textareaInput", void 0);
OneTextarea = __decorate([
    n$1('one-textarea')
], OneTextarea);

let OneDivider = class OneDivider extends OneBase {
    constructor() {
        super();
        this.elevation = 1;
...
__decorate([
    e({ type: Number }),
    __metadata("design:type", Object)
], OneDivider.prototype, "elevation", void 0);
OneDivider = __decorate([
    n$1('one-divider'),
    __metadata("design:paramtypes", [])
], OneDivider);

let OneDialog = class OneDialog extends s {
    constructor() {
        super(...arguments);
        this.open = false;
    }
...
__decorate([
    e({ type: Boolean, reflect: true }),
    __metadata("design:type", Object)
], OneDialog.prototype, "open", void 0);
__decorate([
    i('one-card'),
    __metadata("design:type", OneCard)
], OneDialog.prototype, "card", void 0);
OneDialog = __decorate([
    n$1('one-dialog')
], OneDialog);

let OneTab = class OneTab extends OneBase {
    constructor() {
        super(...arguments);
        this.name = '';
        this.label = '';
...
__decorate([
    e({ type: String }),
    __metadata("design:type", Object)
], OneTab.prototype, "name", void 0);
__decorate([
    e({ type: String }),
    __metadata("design:type", Object)
], OneTab.prototype, "label", void 0);
OneTab = __decorate([
    n$1('one-tab')
], OneTab);

let OneTabs = class OneTabs extends s {
    constructor() {
        super(...arguments);
        this.pages = [];
...
__decorate([
    e({ type: String }),
    __metadata("design:type", String)
], OneTabs.prototype, "selected", void 0);
__decorate([
    i('slot'),
    __metadata("design:type", HTMLSlotElement)
], OneTabs.prototype, "slotElement", void 0);
OneTabs = __decorate([
    n$1('one-tabs')
], OneTabs);

export { OneButton, OneCard, OneCheckbox, OneCircle, OneCombo, OneDialog, OneDivider, OneInput, OneItem, OneListbox, OneProgress, OneRadio, OneRadioGroup, OneSlider, OneSpinner, OneSquare, OneTab, OneTabs, OneTextarea, OneToggle };
