...
/*jslint unparam: true */
(function () {
	var page = document.getElementById("selectModePageAllCE"),
		listview = document.querySelector("#selectModePageAllCE .ui-listview"),
		...
		selectAll = document.getElementById("select-allCE"),
		deselectAll = document.getElementById("deselect-allCE"),
		elPopup = page.querySelector("#moreoptionsPopupCircleCE"),
		handler = page.querySelector(".ui-more"),
		selector = page.querySelector("#selector2-ce"),
		liPopupSelect = document.querySelector("#select-allCE").parentElement,
		liPopupDeselect = document.querySelector("#deselect-allCE").parentElement,
		selectorComponent,
		snapList,
		selectCount = 0,
		popupHandler,
