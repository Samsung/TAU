(function (tau) {
	 ...
	 */
	var page = document.getElementById("46-index-scroll-bar-page-ce"),
		isbElement = document.getElementById("46-index-scroll-bar-ce"),
		dividers = page.getElementsByClassName("ui-group-index"),
		testedIndex = document.getElementById("tested-index-ce"),
		isb,
		scroller,
		dividerIndexObject = {},
		selectBound;
	...
	page.addEventListener("pagebeforeshow", function () {
		...
		scroller = tau.util.selectors.getScrollableParent(document.getElementById("46-index-scroll-bar-list-ce"));
		len = dividers.length;
		for (i = 0; i < len; i++) {
	...
	page.addEventListener("pageshow", function () {
		var element = document.getElementById("46-index-scroll-bar-ce"),
