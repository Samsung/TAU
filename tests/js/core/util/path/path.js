/*global tau, document: false, window: false,
 module: false, test:false, equal: false*/
document.addEventListener("DOMContentLoaded", function () {
	"use strict";
	var path = tau.util.path,
	...
	test("clean", function () {
		equal(path.clean("http://localhost/index.html", tau.util.path.parseUrl("http://localhost/index.html")), "/index.html", "clean for \"http://localhost/index.html\"");
		equal(path.clean("http://localhost/test/index.html", tau.util.path.parseUrl("http://localhost/index.html")), "/test/index.html", "clean for \"http://localhost/test/index.html\"");
	});
	...
	test("isExternal", function () {
		...
		equal(path.isExternal("http://localhost/index.html#hash", tau.util.path.parseUrl("http://localhost2/index.html")), true, "isExternal for {a: \"b\", c:\"d\"}");
		equal(path.isExternal("#hash", tau.util.path.parseUrl("http://localhost/index.html")), false, "isExternal for {a: \"b\", c:\"d\"}");
	});
	...
	test("isFirstPageUrl", function () {
		...
		equal(path.isFirstPageUrl("index.html#hash", firstPage,
			tau.util.path.parseUrl("http://localhost/index.html"),
			null,
			tau.util.path.parseUrl("http://localhost/index.html")), false, "isFirstPageUrl for {a: \"b\", c:\"d\"}");
		equal(path.isFirstPageUrl("index.html#test1", firstPage,
			tau.util.path.parseUrl("http://localhost/index.html"),
			null,
			tau.util.path.parseUrl("http://localhost/index.html")), true, "isFirstPageUrl for {a: \"b\", c:\"d\"}");
	});

	test("isPermittedCrossDomainRequest", function () {
		equal(path.isPermittedCrossDomainRequest(tau.util.path.parseUrl("http://localhost/aaa.html"), "http://localhost/bbb.html"), false, "isPermittedCrossDomainRequest");
		equal(path.isPermittedCrossDomainRequest(tau.util.path.parseUrl("file://localhost/aaa.html"), "http://localhost2/bbb.html"), false, "isPermittedCrossDomainRequest");
		tau.set("allowCrossDomainPages", true);
		equal(path.isPermittedCrossDomainRequest(tau.util.path.parseUrl("http://localhost/aaa.html"), "http://localhost/bbb.html"), false, "isPermittedCrossDomainRequest");
		equal(path.isPermittedCrossDomainRequest(tau.util.path.parseUrl("file://localhost/aaa.html"), "http://localhost2/bbb.html"), true, "isPermittedCrossDomainRequest");
	});
