...
test("ej.util.callbacks - check function add", function () {
	var fn = function () {
		...
		fn1 = function () {
			equal(this, window, "Basic binding and firing (context), callback was added with success");
		},
		count = 0;
...
test("ej.util.callbacks - check function disable", function () {
	...
	equal(output, "X", "Adding a callback after disabling");
	callbacks.fire("A");
