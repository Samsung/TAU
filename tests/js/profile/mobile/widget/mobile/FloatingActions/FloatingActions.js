...
(function () {
	...
	function runTests(FloatingActions, helpers, ns) {
		...
		function initHTML() {
			var HTML = helpers.loadHTMLFromFile("/base/tests/js/profile/mobile/widget/mobile/FloatingActions/test-data/sample.html"),
				parent = document.getElementById("qunit-fixture") || helpers.initFixture();

			parent.innerHTML = HTML;
		}

		module("profile/mobile/widget/mobile/FloatingActions", {
			setup: initHTML
		});
