...
(function () {
	...
	function runTests(engine, selectors, Listview, helpers, ns) {
		...
		function initHTML() {
			return new Promise(function (resolve) {
				var HTML = helpers.loadHTMLFromFile("/base/tests/js/profile/mobile/widget/Listview/test-data/sample.html"),
	...
	if (typeof define === "function") {
		...
		], function (engine, selectors, Listview, helpers, tau) {
			return runTests.bind(null, engine, selectors, Listview, helpers, tau);
		});
	} else {
		runTests(
			tau.engine,
