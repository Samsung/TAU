...
module.exports = function (config) {
	config.set({
		...
		files: [
            ...
            {pattern: "examples/wearable/circular/CircularUIComponents/**/*", included: false, served: true},
            {pattern: "examples/wearable/circular/CircularUIComponentsCE/**/*", included: false, served: true},
